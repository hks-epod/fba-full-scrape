    ...
    def parse(self, response):
        ...
        try:
            ...
            for link in muster_links:
                ...
                if not ((mr_tracker.msr_no==msr_no) & (mr_tracker.work_code==work_code)).any() and dt>=datetime.datetime(2015,9,1): # If we don't find the msr_no/work_code in the scraped data and the date is since 9/1/2016 we want to mark it
